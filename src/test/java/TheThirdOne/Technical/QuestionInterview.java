...
public class QuestionInterview {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Integer> list = new ArrayList<>(Arrays.asList(1, 1, 1, 1, 1, 1, 1, 2, 3, 2, 3, 2, 3, 4, 4, 5, 6, 7, 7, 8, 9));
        System.out.println(removeDup(list));
    }

	/*
	 1. Create a method that can remove duplicated values from an
		ArrayList.  Do not use Set interfaces.
		ArrayList<Integer>list = new ArrayList<>(Arrays.asList(1,1,1,1,1,1,1,2,3,2,3,2,3,4,4,5,6,7,7,8,9));
	 */
    ...
    */
    ...
    /*
   11. Write a method without using mod operator
     */
   ...
   12 Fibonacci
    ...
    /*
    13.   Sum number of digits
     */

    public static void sumOfTheNumber() {
    ...
    14.  reverse an TheThirdOne.Pages.Array with temp variable
     */
    ...
    /*
    15. write a method that remove duplicates inside the string
